...
if __name__ == "__main__" :
    ...
    print "Saving the Calibration histograms in EffTable/{}/EffHisto_Calib_L0-{}_{}_{}_{}-{}.root".format(Tag_name, "MC", channelMC, year,"mBoth",  Tag_name)
    file_root_MC = TFile("EffTable/{}/EffHisto_Calib_L0-{}_{}_{}_{}-{}.root".format(Tag_name, "MC", channelMC, year,"mBoth",  Tag_name),"RECREATE")
    ...
    #######
    print "Saving the Calibration histograms in EffTable/{}/EffHisto_Calib_L0-{}_{}_{}_{}-{}.root".format(Tag_name, "Data", channelData, year, "mBoth", Tag_name)
    file_root_Data = TFile("EffTable/{}/EffHisto_Calib_L0-{}_{}_{}_{}-{}.root".format(Tag_name, "Data", channelData, year, "mBoth", Tag_name),"RECREATE")
